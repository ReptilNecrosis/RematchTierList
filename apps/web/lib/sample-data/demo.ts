...
export const teams: Team[] = [
  { id: "team-nx", slug: "nexforce", name: "NexForce", shortCode: "NX", tierId: "tier1", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-vg", slug: "vanguard", name: "Vanguard", shortCode: "VG", tierId: "tier1", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-ik", slug: "ironknights", name: "IronKnights", shortCode: "IK", tierId: "tier1", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-zn", slug: "zenith", name: "Zenith", shortCode: "ZN", tierId: "tier1", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-px", slug: "phantom-xi", name: "Phantom XI", shortCode: "PX", tierId: "tier1", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-nv", slug: "nova", name: "Nova", shortCode: "NV", tierId: "tier2", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-bl", slug: "bladelight", name: "BladeLight", shortCode: "BL", tierId: "tier2", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-cr", slug: "crimsonrush", name: "CrimsonRush", shortCode: "CR", tierId: "tier2", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-kr", slug: "kryptos", name: "Kryptos", shortCode: "KR", tierId: "tier2", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-rv", slug: "revenant", name: "Revenant", shortCode: "RV", tierId: "tier2", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-ar", slug: "arcane", name: "Arcane", shortCode: "AR", tierId: "tier3", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-hl", slug: "hollow", name: "Hollow", shortCode: "HL", tierId: "tier3", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-dk", slug: "darkside", name: "Darkside", shortCode: "DK", tierId: "tier3", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-rz", slug: "razorback", name: "Razorback", shortCode: "RZ", tierId: "tier3", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-sw", slug: "swiftblade", name: "Swiftblade", shortCode: "SW", tierId: "tier3", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-pt", slug: "penitent", name: "Penitent", shortCode: "PT", tierId: "tier3", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-cf", slug: "coldfront", name: "Coldfront", shortCode: "CF", tierId: "tier4", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-sk", slug: "skyline", name: "Skyline", shortCode: "SK", tierId: "tier4", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-vx", slug: "vortex", name: "Vortex", shortCode: "VX", tierId: "tier4", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-ec", slug: "eclipse", name: "Eclipse", shortCode: "EC", tierId: "tier5", verified: true, createdAt: iso(1), addedBy: "owner" },
  { id: "team-hb", slug: "harbor", name: "Harbor", shortCode: "HB", tierId: "tier5", verified: true, createdAt: iso(1), addedBy: "owner" },
